    ...
    children: [
      {
        ...
        data: {
          title: 'Live Currency Converter (170+ Currencies) – Real-Time Exchange Rates | CalculHub',
          description: 'Convert between 170+ world currencies using real-time exchange rates. Supports USD, INR, EUR, GBP, AED, CAD, and more. Free online currency converter — no signup required.',
          ogTitle: 'Live Currency Converter – Real-Time Exchange Rates for 170+ World Currencies',
          ogDescription: 'Free online currency converter with real-time rates for 170+ currencies. Convert USD, INR, EUR, GBP, AED and more instantly. No signup required.',
          keywords: 'currency converter, live exchange rates, USD to INR, EUR to INR, GBP to INR, AED to INR, CAD to INR, dollar to rupee calculator, real time exchange rate, currency conversion calculator, forex rates today',
          publishedTime: '2025-01-01T00:00:00+05:30',
          modifiedTime: '2026-07-05T00:00:00+05:30',
          ...
          schema: [calcSchema('Currency Converter', `${BASE_URL}/market/currency-converter`, 'Free live currency converter supporting 170+ world currencies with real-time ECB exchange rates, popular pair comparisons, and conversion tables.', 'FinanceApplication'),
            {
              '@context': 'https://schema.org', '@type': 'FAQPage',
              mainEntity: [
                { '@type': 'Question', name: 'What is the difference between buy, sell, and mid-market rates?', acceptedAnswer: { '@type': 'Answer', text: 'The mid-market rate (or interbank rate) is the real midpoint between the buy and sell rates on global financial markets. Banks and exchange booths add a spread on top of this rate — they buy from you at a lower rate and sell to you at a higher rate, profiting from the difference. This converter displays the mid-market rate, which is the fairest benchmark for any currency conversion.' } },
                { '@type': 'Question', name: 'Why do exchange rates change every day?', acceptedAnswer: { '@type': 'Answer', text: 'Currencies are traded freely on global markets, so supply and demand forces react instantly to trade flows, central bank announcements, employment statistics, geopolitical events, and large institutional trades. The forex market trades over $7 trillion daily, meaning rates can — and do — move continuously throughout the trading day.' } },
                { '@type': 'Question', name: 'Is it better to exchange currency before traveling or at the destination?', acceptedAnswer: { '@type': 'Answer', text: 'Generally, using a local ATM at your destination with a low-fee international debit card gives you rates close to the mid-market rate and is more convenient than carrying large amounts of cash. If you must exchange cash, avoid airport kiosks and use a bank or reputable currency exchange in the city.' } },
                { '@type': 'Question', name: 'What is a pip in currency trading?', acceptedAnswer: { '@type': 'Answer', text: 'A pip (percentage in point) is the smallest standard unit of price movement in a currency pair, typically 0.0001 for most pairs (or 0.01 for pairs involving the Japanese Yen). Traders use pips to measure profit and loss and to set stop-loss and take-profit levels.' } },
                { '@type': 'Question', name: 'What is a safe-haven currency?', acceptedAnswer: { '@type': 'Answer', text: 'A safe-haven currency is one that investors tend to buy during periods of global uncertainty or market turmoil, believing it will retain or increase its value. The most commonly cited safe havens are the US Dollar, Swiss Franc, and Japanese Yen, thanks to their countries\' political stability and deep financial markets.' } },
                { '@type': 'Question', name: 'How does the Reserve Bank of India manage the Rupee?', acceptedAnswer: { '@type': 'Answer', text: 'The RBI operates a managed float regime. It allows the Rupee to move with market forces but intervenes when volatility is excessive — buying Dollars to prevent rapid Rupee appreciation or selling Dollars to support the Rupee during sharp depreciation. India\'s large foreign exchange reserves give the RBI significant capacity to intervene.' } },
                { '@type': 'Question', name: 'Can I use this converter for cryptocurrency exchanges?', acceptedAnswer: { '@type': 'Answer', text: 'This converter is designed for traditional fiat currencies and sources rates from central bank reference data. For cryptocurrency pairs such as BTC/USD or ETH/INR, please use our dedicated Crypto Calculator.' } },
                { '@type': 'Question', name: 'How often are the exchange rates updated?', acceptedAnswer: { '@type': 'Answer', text: 'Rates are sourced from the Frankfurter API, which publishes European Central Bank reference rates updated on every business day at approximately 16:00 CET. While not tick-by-tick live data, ECB reference rates are widely used as an objective, commercially neutral benchmark.' } },
                { '@type': 'Question', name: 'How do I convert USD to INR?', acceptedAnswer: { '@type': 'Answer', text: 'Enter your amount in the converter above, select USD as the base currency and INR as the target currency. The tool instantly calculates the equivalent amount using the latest ECB reference rate. You can also click the "USD → INR" quick button for an instant preset.' } },
                { '@type': 'Question', name: 'Which currency converter is most accurate?', acceptedAnswer: { '@type': 'Answer', text: 'The most accurate converters use mid-market (interbank) rates sourced from central banks or aggregated from major financial data providers. This converter uses European Central Bank reference rates via the Frankfurter API, providing a transparent, commercially neutral benchmark without hidden markups.' } }
              ]
            }]
        }
      },
