...
export class SidePanelComponent implements OnInit, OnDestroy {
  ...
  calculatorCards = signal<CalculatorCard[]>([
    ...
    { icon: 'car', title: 'Car Loan EMI Calculator', description: 'Calculate your monthly car loan payments (EMI) and see a breakdown of principal and interest.', link: '/financial/car-loan-emi-calculator', category: 'Financial' },
    ...
    { icon: 'wallet', title: 'NPS Calculator', description: 'Estimate pension and lumpsum withdrawal under the National Pension Scheme.', link: '/financial/nps-calculator', category: 'Financial' },
    ...
    { icon: 'graduation-cap', title: 'GPA Calculator', description: 'Calculate grade point average with custom credits.', link: '/mathematical/gpa-calculator', category: 'Mathematical' },
    ...
    { icon: 'baby', title: 'Pregnancy Calculator', description: 'Calculate your estimated due date, trimester, and milestones.', link: '/health/pregnancy-calculator', category: 'Health & Fitness' },
